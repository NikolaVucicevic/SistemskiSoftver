# SistemskiSoftver
# Sistemski Softver – Two-Pass Assembler
...
.
├── inc/ # Header files for core backend
├── src/ # Implementation of backend and parser wrapper
├── asembler/ # Bison/Flex grammar & definitions
├── tests/ # Example test .s files
├── generated.o # Example build output (bytecode)
├── README.md # This file
└── .vscode/ # IDE config
